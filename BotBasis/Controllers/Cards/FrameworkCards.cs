...
namespace BotBasis.Controllers.Cards
{
    ...
    public static class FrameworkCards
    {
        ...
        public static Activity createCarusel(List<Activity> actiList, Activity message)
        {

            Activity replyToConversation = message.CreateReply("test");
            ...
            foreach( Activity act in actiList)
            {
                replyToConversation.Attachments.Add(act.Attachments.First());
            }            
